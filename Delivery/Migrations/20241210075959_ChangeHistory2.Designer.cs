...
namespace Delivery.Migrations
{
    ...
    [Migration("20241210075959_ChangeHistory2")]
    partial class ChangeHistory2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Delivery.Models.Cargo", b =>
                {
                    b.HasOne("Delivery.Models.Flight", "Flight")
                        .WithOne("Cargo")
                        .HasForeignKey("Delivery.Models.Cargo", "FlightId")
            ...
            modelBuilder.Entity("Delivery.Models.Driver", b =>
                {
                    b.HasOne("Delivery.Models.Auth", "Auth")
                        .WithOne("Driver")
                        .HasForeignKey("Delivery.Models.Driver", "AuthId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Delivery.Models.Operator", b =>
                {
                    b.HasOne("Delivery.Models.Auth", "Auth")
                        .WithOne("Operator")
                        .HasForeignKey("Delivery.Models.Operator", "AuthId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
